document.addEventListener('DOMContentLoaded', () => {
  ...
  html += `
      ...
      <h4 class="text-base font-bold mt-6 mb-3 text-gray-800 flex items-center gap-2">
        ...
        نقل عفش من جدة إلى المدن الأخري
      </h4>
